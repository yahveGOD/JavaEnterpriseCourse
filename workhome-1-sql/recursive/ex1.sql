...
INSERT INTO bookings (bookid,facid,memid,starttime,slots) VALUES (2,1,3,'2012-09-14 13:00:00',2);
INSERT INTO bookings (bookid,facid,memid,starttime,slots) VALUES (3,1,5,'2012-09-14 14:00:00',2);
INSERT INTO bookings (bookid,facid,memid,starttime,slots) VALUES (4,1,3,'2012-09-14 15:00:00',3);
INSERT INTO bookings (bookid,facid,memid,starttime,slots) VALUES (5,1,3,'2012-09-14 16:00:00',23);

with recursive recmembers(recmember) as(
	select recommendedby from cd.members where memid = 27
	union all
	select mems.recommendedby
		from recmembers rec
		inner join members mems
			on mems.memid = rec.recmember  
  )
select rec.recmember,mems.firstname,mems.surname
from recmembers rec
	inner join members mems
		on rec.recmember = mems.memid
order by memid desc  