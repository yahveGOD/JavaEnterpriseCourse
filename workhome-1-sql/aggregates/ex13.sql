...
INSERT INTO bookings (bookid,facid,memid,starttime,slots) VALUES (5,1,3,'2012-09-14 16:00:00',1023);

select fac.facid,fac.name,trim(to_char(sum(bks.slots)/2.0, '9999999999999999D99')) as "Total Hours"
from bookings bks
