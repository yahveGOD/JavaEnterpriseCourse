...
INSERT INTO bookings (booking_id,facility_id,member_id,start_time,slots) VALUES (5,1,3,'2012-09-14 16:00:00',23);

select fac.facility_id,fac.name,trim(to_char(sum(bks.slots)/2.0, '9999999999999999D99')) as "Total Hours"
from bookings bks
inner join facilities fac
	on fac.facility_id = bks.facility_id
group by fac.facility_id,fac.name
order by fac.facility_id