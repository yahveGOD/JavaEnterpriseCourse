...
select mems.surname,mems.firstname,mems.member_id,min(bks.start_time) as start
from members mems
	inner join bookings bks
	 on bks.member_id = mems.member_id
	 where start_time>='2012-09-01'
	 group by mems.surname, mems.firstname, mems.member_id
order by mems.member_id