...
INSERT INTO bookings (bookid,facid,memid,starttime,slots) VALUES (2,1,3,'2012-09-21 13:00:00',2);
INSERT INTO bookings (bookid,facid,memid,starttime,slots) VALUES (3,1,5,'2012-09-21 14:00:00',2);
select distinct mems1.firstname as firstname, mems1.surname as surname
	from 
		members mems
		inner join members mems1
			on mems1.memid = mems.recommendedby
